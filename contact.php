    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-8">
                <h3 class="mb-30"><b>Tinggalkan komentar</b></h3>
                <form class="my-contact-form" action="thanks.php">
                    <div class="row">
                        <div class="col-md-6">
            ...
            <div class="col-sm-12 col-md-4">
                <h3 class="mb-20 mt-sm-50"><b>Informasi</b></h3>

                <ul>
                    <li>Ds. Jamika No. 194, Gorontalo 31370, JaTim</li>
                    <li>prahimah@hartati.tv<span class="server-name"></span></li>
                    <li>+5599019675369</li>
                </ul>
            </div><!-- col-md-6 -->
        </div><!-- row -->

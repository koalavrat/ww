...
<body class="d-flex flex-column h-100 w-100 bg)">
    <!-- Preloader Start -->
    <div id="preloader">
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        ...
                        <h2 class="logo text-uppercase">
                            <a href="index.php">Blog kesehatan</a>
                        </h2>
                        <!-- End of Logo -->
                    </div>
    ...
    <!-- ****** Thanks Area Start ****** -->
    <section class="archive-area section_padding_80 pt-5 flex-grow-1">
        <div class="container">
            <div class="row">
                <p align="center">Terima kasih atas permintaan Anda!</p>
            </div>
        </div>
    </section>
    <!-- ****** Thanks Area End ****** -->
